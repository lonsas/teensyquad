...
TESTABLESOURCES = src/PID.o src/GyroControl.o src/Sensor.o libraries/MadgwickAHRS/MadgwickAHRS.o src/PIDConf.o src/mix.o src/QuadState.o src/Control.o src/AngleControl.o src/Receiver.o src/EscControl.o src/UsbCommunication.o host_src/dummyHostFunctions.o
